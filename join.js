...
function init(extend) {
    log("零硬编码爬虫 v19 (连续剧增强版) 初始化", "INFO");
...
function detail(vodId) {
    ...
    // ========== 新增：连续剧模式（自动解析多集） ==========
        ...
        let vod = {
            vod_id: seriesUrl + "###series",   // 保持唯一标识
