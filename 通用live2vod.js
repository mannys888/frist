...
// ========== 外部接口：init, home, homeVod, category, detail, play, search ==========
function init(ext) {
  print(`初始化 ${VERSION}`);
  let configData = null;
