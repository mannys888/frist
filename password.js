// ==================== 通用动态爬虫 v34（稳定密码锁，分类伪装键盘） ====================
// 使用说明：未解锁时首页显示“🔒 点击解锁”，点击后进入分类键盘视频列表
// 点击“爱情片”=输入1，“动作片”=2，... “音乐”=0，顶部视频显示已输入的数字
...
const VERSION = 'universal v3.4 (stable password lock)';
const tips = `\n${VERSION}`;
